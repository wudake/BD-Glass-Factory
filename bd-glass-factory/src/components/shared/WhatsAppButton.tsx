...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <div className="bg-white shadow-lg rounded-lg px-4 py-3 text-sm max-w-[200px] relative animate-bounce">
          <button
            ...
            className="absolute -top-1.5 -right-1.5 w-6 h-6 bg-brand-muted rounded-full flex items-center justify-center hover:bg-brand-muted-dark transition-colors"
      ...
      {/* Button — 56×56 touch target, active feedback */}
      <a
        href={whatsappUrl}
        target="_blank"
